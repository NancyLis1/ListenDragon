...
当前后端已在 T03/T05 骨架上完成 T07-T13：上传与任务持久化、媒体提取、转写、分块、FAISS/BM25 双索引发布、多查询扩展与 RRF 混合检索，以及带持久化会话、服务器时间戳、二次证据核验和拒答策略的 QA/摘要 API。浏览器问答闭环仍需前端联调及 T15/T16 综合验收。详见 [T12 检索交接](docs/t12-handoff.md)和 [T13 QA/摘要交接](docs/t13-handoff.md)。
